...
public final class HelloServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.grpc.hello.HelloModel.GreetingRequest,
      com.grpc.hello.HelloModel.GreetingReply> METHOD_GET_GREETING =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "grpc.hello.HelloService", "GetGreeting"),
          io.grpc.protobuf.ProtoUtils.marshaller(com.grpc.hello.HelloModel.GreetingRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(com.grpc.hello.HelloModel.GreetingReply.getDefaultInstance()));
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getGreeting(com.grpc.hello.HelloModel.GreetingRequest request,
        io.grpc.stub.StreamObserver<com.grpc.hello.HelloModel.GreetingReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.grpc.hello.HelloModel.GreetingRequest,
                com.grpc.hello.HelloModel.GreetingReply>(
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public com.grpc.hello.HelloModel.GreetingReply getGreeting(com.grpc.hello.HelloModel.GreetingRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.grpc.hello.HelloModel.GreetingReply> getGreeting(
        com.grpc.hello.HelloModel.GreetingRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_GREETING:
          serviceImpl.getGreeting((com.grpc.hello.HelloModel.GreetingRequest) request,
              (io.grpc.stub.StreamObserver<com.grpc.hello.HelloModel.GreetingReply>) responseObserver);
          break;
        default:
  ...
  private static final class HelloServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.grpc.hello.HelloModel.getDescriptor();
    }
  }
